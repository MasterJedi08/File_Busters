...
def preprocess():
   ...
   # print(train_padded[1000:1030])
    ...
    return train_padded, train_email_labels, test_padded, test_email_labels, tokenizer
...
def train(train_emails, train_labels, test_emails, test_labels, NUM_EPOCHS, batchsize, neurons):
    ...
    try:
        ...
        # save model
        # model.save(FILENAME)
        tfjs.converters.save_keras_model(model, 'file_busters_js_7.h5')
...
# preprocess data
train_emails, train_labels, test_emails, test_labels, token_lib = preprocess()
...
text_given = input("email given:")



text_return = preprocess_input_email(text_given, token_lib, model)
#print(text_return)
